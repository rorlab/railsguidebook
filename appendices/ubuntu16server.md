...
![](/assets/2016-12-19_08-40-59_zpspx48ymyk.png)
...
![](/assets/2016-12-19_09-24-15_zpsdye0pmgu.png)

#### 42. 로그인 화면

아래와 같은 로그인 화면이 나타나면 등록한 유저 계정명과 암호를 이용하여 로그인한다.

![](/assets/2016-12-19_08-47-46_zpsqiowrj09.png)

##### 43. 로그인 후 화면

![](/assets/2016-12-19_08-50-52_zpsdrxzbgbv.png)
...
![](/assets/2016-12-19_08-54-09_zpsfg0dg4su.png)
...
![](/assets/2016-12-19_08-56-26_zpssm5juy3w.png)

## 서버 웹운영 환경 설정

이제부터는 [우분투 12.04 서버 세팅하기](/appendices/ubuntu_12_4_setting.md) 챕터의 내용 중 `서버 설치과정`을 보고 따라하면 된다. 
