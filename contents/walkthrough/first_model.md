...
`Post`라는 모델을 작성해 보자. 이 모델은 `title`\(글제목\)과 `content`\(글내용\) 두개의 속성으로 구성한다. 나중에 필요한 속성을 추가할 것이다. 커맨드라인에서 아래와 같이 명령을 실행한다.
...
database: rcafe2_development
 ...
 Status   Migration ID    Migration Name
--------------------------------------------------
   down     20161210103346  Create posts
```
...
이제 브라우저에서 [http://localhost:3000/posts](http://localhost:3000/posts) 로 접근하면 아래와 같은 화면을 볼 수 있다.

![posts\_index](http://i1373.photobucket.com/albums/ag392/rorlab/Photobucket Desktop - RORLAB/rcafe/2015-01-30_15-47-26_zpsd0567b97.png)
...
브라우저 상에서 데이터를 _추가_, _삭제_, _변경_해서 문제없이 잘 수행되는 것을 확인한다.
...
> **Git소스** [https://github.com/rorlab/rcafe2/tree/chapter\_05\_03](https://github.com/rorlab/rcafe2/tree/chapter_05_03)
